...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('sub_domain_hosting', function (Blueprint $table) {
            $table->id();
            $table->string('nama_pemohon', 255);
            $table->string('nip_nik', 50);
            $table->string('nama_website_aplikasi', 255);
            $table->string('nama_subdomain_dipinta', 255);
    ...
    {
        Schema::dropIfExists('sub_domain_hosting');
    }
};
