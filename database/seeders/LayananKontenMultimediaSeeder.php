...
class LayananKontenMultimediaSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        DB::table('layanan_konten_multimedia')->insert([
            [
                'nama_pemohon' => 'Pemohon 1',
                'nip_nik' => '1234567890',
                'peruntukan' => 'Peruntukan 1',
                'unit_kerja' => 'Unit 1',
