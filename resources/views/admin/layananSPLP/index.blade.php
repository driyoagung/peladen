                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-4 text-sm">
                                ...
                                <form action="{{ route('admin.layananSPLP.destroy', $layananSPLP->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="flex flex-col px-4 py-3 text-sm font-medium text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
            <div class="flex items-center justify-between">
                <span class="text-gray-700 dark:text-gray-300">
                    Menampilkan {{ $layananSPLPs->firstItem() }} hingga {{ $layananSPLPs->lastItem() }} dari {{ $layananSPLPs->total() }} hasil
                </span>
                <div class="flex items-center">
                    <!-- Pagination Links -->
                    {{ $layananSPLPs->links('pagination::tailwind') }}
                </div>
            </div>
        </div>
</div>
