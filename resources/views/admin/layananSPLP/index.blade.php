...
<div class="container grid px-6 mx-auto">
    ...
    <div class="mb-4">
        <a href="{{ route('admin.layananSPLP.create') }}" class="px-4 py-2 text-sm font-medium leading-5 text-white bg-purple-600 rounded-lg focus:outline-none focus:shadow-outline-purple">
            Create New Layanan SPLP
        </a>
    </div>
