            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-gray-800">
                <div class="p-6">
                    ...
                    @if ($kategori->kategori_layanan == 'Layanan TTE')
                        <p class="text-gray-700 mb-4 dark:text-gray-400">Tanda Tangan Elektronik (TTE) adalah layanan yang memungkinkan Anda untuk menandatangani dokumen secara digital dengan validitas hukum.</p>
