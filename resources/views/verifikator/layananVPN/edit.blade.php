        ...
        <div class="px-6 py-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananVPN->unit_kerja }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>Tanggal Permohonan:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananVPN->tanggal_permohonan }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>Waktu Permohonan:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananVPN->waktu_permohonan }}</p>
                </div>
            ...
            <div class="mt-6">
                ...
                <a href="{{ route ('verifikator.layananVPN') }}">
...
<div id="statusModal" class="fixed inset-0 flex items-center justify-center hidden bg-gray-900 bg-opacity-50 z-50 transition-opacity duration-300 ease-out">
    <div class="modal-content bg-white dark:bg-gray-800 rounded-lg shadow-md w-full max-w-md transform transition-transform duration-300 scale-90 opacity-0">
        <div class="px-6 py-4">
            ...
            <form id="statusForm" method="POST" action="{{ route('verifikator.layananVPN.updateStatus', $layananVPN->id) }}">
                @csrf
                @method('PUT')
                <div class="mb-4">
