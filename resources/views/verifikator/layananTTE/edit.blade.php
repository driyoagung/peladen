    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4">
            <h4 class="text-lg font-semibold text-gray-600 dark:text-gray-300 mb-4">
                Informasi Layanan TTE
            </h4>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <!-- Detail Fields -->
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>Nama Lengkap:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananTTE->nama_lengkap }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>No. KTP:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananTTE->ktp }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>NIK:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananTTE->nik }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>NIP:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananTTE->nip }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>Jabatan:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananTTE->jabatan }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>No. HP:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananTTE->no_hp }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>Unit Kerja:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananTTE->unit_kerja }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>Tanggal Permohonan:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananTTE->tanggal_permohonan }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>Waktu Permohonan:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananTTE->waktu_permohonan }}</p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    @php
                        $status = $layananTTE->statusPermohonan ? $layananTTE->statusPermohonan->status : 'N/A';
            ...
            <div class="mt-6">
                ...
                <a href="{{ route ('verifikator.layananTTE') }}">
...
<div id="statusModal" class="fixed inset-0 flex items-center justify-center hidden bg-gray-900 bg-opacity-50 z-50 transition-opacity duration-300 ease-out">
    <div class="modal-content bg-white dark:bg-gray-800 rounded-lg shadow-md w-full max-w-md transform transition-transform duration-300 scale-90 opacity-0">
        <div class="px-6 py-4">
            ...
            <form id="statusForm" method="POST" action="{{ route('verifikator.layananTTE.updateStatus', $layananTTE->id) }}">
                @csrf
                @method('PUT')
                <div class="mb-4">
