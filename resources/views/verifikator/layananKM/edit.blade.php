...
<div class="container px-6 mx-auto grid">
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
        Detail Layanan Konten Multimedia
    </h2>
     <!-- Alert Sukses -->
     @if (session('success'))
     <script>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4">
            <h4 class="text-lg font-semibold text-gray-600 dark:text-gray-300 mb-4">
                Informasi Layanan Konten Multimedia
            </h4>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <!-- Detail Fields -->
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>Nama Pemohon:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananKM->nama_pemohon }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>NIP/NIK:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananKM->nip_nik }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>Peruntukan:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananKM->peruntukan }}</p>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananKM->unit_kerja }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>Tanggal Permohonan:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananKM->tanggal_permohonan }}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-700 dark:text-gray-400 mb-2"><strong>Waktu Permohonan:</strong></p>
                    <p class="text-gray-900 dark:text-gray-100">{{ $layananKM->waktu_permohonan }}</p>
                </div>
            ...
            <div class="mt-6">
                ...
                <a href="{{ route ('verifikator.layananKM') }}">
...
<div id="statusModal" class="fixed inset-0 flex items-center justify-center hidden bg-gray-900 bg-opacity-50 z-50 transition-opacity duration-300 ease-out">
    <div class="modal-content bg-white dark:bg-gray-800 rounded-lg shadow-md w-full max-w-md transform transition-transform duration-300 scale-90 opacity-0">
        <div class="px-6 py-4">
            ...
            <form id="statusForm" method="POST" action="{{ route('verifikator.layananKM.updateStatus', $layananKM->id) }}">
                @csrf
                @method('PUT')
                <div class="mb-4">
