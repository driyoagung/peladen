  ...
  <body class="bg-slate-100">
    ...
    <header>
      <div class="container max-w-full flex flex-col md:flex-row justify-between items-center pt-10 p-4 sm:p-6 md:p-8">
        <div class="flex items-center mb-4 md:mb-0">
          ...
          <a href="/manualbook"  target="_blank">
    ...
    <div class="container mx-auto max-w-screen-lg p-4 sm:p-6 md:p-8 my-6 md:my-10">
      <div class="flex flex-col xl:flex-row items-center xl:items-start relative z-10 max-w-6xl xl:ml-12">
        <div class="flex-none  rounded-xl hidden xl:block">
    ...
    <div id="layanan" class="my-12 mx-auto max-w-screen-lg pt-20 px-4 sm:px-6 md:px-8 lg:px-16">
      <div class="container mx-auto flex justify-center">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-16">
          ...
          <a href="#{{ $kategori->id }}" class="block no-underline myButton">
            <div class="relative font-semibold flex flex-col items-center text-gray-700 bg-white shadow-xl rounded-xl w-36 h-40 transition-transform duration-500 hover:scale-105 cursor-pointer">
    ...
    @php
        ...
        $backgroundClass = $backgroundClasses[$index % count($backgroundClasses)];
    @endphp
          ...
          <div>
              ...
              <ul>
                  <li class="flex items-center mb-2">
                      ...
                      <a href="diskominfosp@surakarta.go.id">diskominfosp@surakarta.go.id</a>
                  </li>
                  <li class="flex items-center mb-2">
                      <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <span>(0271) 2941667</span>
                  </li>
                  <li class="flex items-center">
                      <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> 
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3"></path>
                      </svg>
                      <span>Gedung Bale Upakari Lantai 3.
                        Jl. Jenderal Sudirman No. 2, Komplek Balaikota Surakarta</span>
                  </li>
              </ul>
          </div>
          <div>
